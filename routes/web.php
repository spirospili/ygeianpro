...
Route::group([
    ...
    */
    ...
    Route::group([
        ...
        Route::resource('society', 'SocietyController', ['as' => 'admin']);
        Route::resource('hospital', 'HospitalController', ['as' => 'admin']);
        Route::resource('subclass', 'SubclassController', ['as' => 'admin']);
