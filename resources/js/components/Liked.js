                            ...
                            <div className="col-md-9">
                                <div className="right-content-area">
                                    ...
                                    <div class="profile-latest-videos">
                                        ...
                                        <div class="row">
                                        <>
                                        {profile.videos && profile.videos.length ? null : 
                                        <h5>You havn't liked any videos.</h5>
                                        }
                                        </>
                                    ...
                                    <div class="medical-block">
                                        ...
                                        <div class="row">
                                        <>
                                        {profile.publications && profile.publications.length ? null : 
                                        <h5>You havn't liked any publication.</h5>
                                        }
                                        </>
