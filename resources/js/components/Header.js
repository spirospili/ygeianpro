...
class Header extends Component {
    ...
    logOut() {
        ...
        console.log("Auth State from Logout", this.context.isAuthenticated);
    }
    ...
    async readNotifications() {
        const userTocken = JSON.parse(localStorage.getItem("appState"))?.user
            ?.access_token;
        axios
            .get("/api/auth/profile?notiifcation=mark_read", {
                headers: {
                    Accept: "application/json",
                    Authorization: `Bearer ${userTocken}`
                }
                                            ...
                                            <>
                                                ...
                                                >
                                                    <img
                                                        ...
                                                        className="img-fluid top-notification"
                                                        alt="notification"
                                                    />
                                                    {this.state
                                                            ...
                                                            (data, index) => (
                                                                <div>
                                                                    {data.data
                                                                        ...
                                                                        <NavLink
                                                                            className="dropdown-item"
                                                                            to={`/doctor-details/${data.data.doctor.id}`}
                                                                        >
                                                                            {
                                                                                data
                                                                                    .data
