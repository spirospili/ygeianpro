...
function DoctorDetailPage() {
        ...
        if (userObj != null) {
            ...
            axios
                ...
                .then(response => {
                    ...
                    axios
                        .get(
                            `/api/hospitals/${response.data.doctor.hospital_id}`
                        )
                        .then(response => {
                            setHospital(response.data);
                        });
                    axios
                        .get(`/api/society/${response.data.doctor.society_id}`)
                        .then(response => {
            ...
            setTrigger(false);
            axios
                .get(`/api/doctors/${docId}?limit=true`, {
                    headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${userTocken}`
                    }
                ...
                .then(response => {
                    ...
                    response.data.doctor.curators.map((data, index) => {
                        if (count < 3) {
                            axios
                                .get(
                                    `/api/masterclasses/${data.masterclass_id}?limit=true`
                                )
                                .then(response => {
                                    console.log(response);
                                    setmasterclass(Array => [
                                        ...Array,
                                        response.data
                                    ]);
                                });
            ...
            axios.get(`/api/doctors/${docId}`).then(response => {
                console.log(response.data);
                setFollows(response.data.doctor);
                setsuggestedDoctors(response.data.suggestedDoctors);
                axios
                    .get(`/api/hospitals/${response.data.doctor.hospital_id}`)
                    .then(response => {
                        setHospital(response.data);
                    });
                axios
            ...
            axios.get(`/api/doctors/${docId}?limit=true`).then(response => {
                console.log(response.data);
                setFollowsLimit(response.data.doctor);
                var count = 0;
                response.data.doctor.curators.map((data, index) => {
    ...
    const tabActive = e => {
        ...
        document
            .getElementById("dr-masterclass-tab")
        ...
        document.getElementById(e.target.id).classList.remove("fade");

        scrollTo(0, 0);
    };
    const activateSection = e => {
        console.log(e);
        document.getElementById("dr-feed").style.display='none';
        document.getElementById("dr-video").style.display='none';
        document.getElementById("dr-images").style.display='none';
        document.getElementById("dr-team").style.display='none';
        document
            .getElementById("dr-masterclass")
            .classList.remove("active");
        document.getElementById("dr-document").style.display='none';
    ...
    return (
        <>
            ...
            <EmailOverlay
                show={invite}
                EmailOverlayClosed={inviteCancelHandler}
            >
                        ...
                        <div className="col-md-3">
                            <div className="sidebar-block">
                                <div className="profile-detail text-center">
                                    <span>
                                        <img
                                            src={`${baseurl}/storage/${follows.path}`}
                                            className="img-fluid"
                                            alt="profile"
                                        />
                                    </span>
                                ...
                                <ul
                                    className="sidebar-menu-list nav nav-tabs"
                                    id="nav-tab"
                                    role="tablist"
                                >
                                    ...
                                    <li>
                                        <a
                                            ...
                                            role="tab"
                                            onClick={() =>
                                                activateSection("dr-feed")
                                            }
                                            aria-controls="dr-feed"
                                            aria-selected="true"
                                        >
                                            Feeds{" "}
                                            <i className="fa fa-chevron-right"></i>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            href="#dr-video"
                                            role="tab"
                                            aria-controls="dr-video"
                                            onClick={() =>
                                                activateSection("dr-video")
                                            }
                                            aria-selected="true"
                                        >
                                            Videos{" "}
                                    ...
                                    <li>
                                        <a
                                            ...
                                            href="#dr-images"
                                            onClick={() =>
                                                activateSection("dr-images")
                                            }
                                            role="tab"
                                            aria-controls="dr-images"
                                            aria-selected="true"
                                        >
                                            Images{" "}
                                            <i className="fa fa-chevron-right"></i>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            href="#dr-document"
                                            onClick={() =>
                                                activateSection("dr-document")
                                            }
                                            role="tab"
                                            aria-controls="dr-document"
                                            aria-selected="true"
                                        >
                                            Document listing{" "}
                                            <i className="fa fa-chevron-right"></i>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            role="tab"
                                            onClick={() =>
                                                activateSection("dr-team")
                                            }
                                            aria-controls="dr-team"
                                            aria-selected="true"
                                        >
                                            Team{" "}
                                            <i className="fa fa-chevron-right"></i>
                                ...
                                >
                                    ...
                                    >
                                                ...
                                                <div className="row mb-2">
                                                    ...
                                                    <div className="col-md-3">
                                                        <a
                                                            ...
                                                            aria-controls="dr-video"
                                                            aria-selected="true"
                                                            className="hvr-icon-wobble-horizontal view-all-btn nav-item nav-link"
                                                        >
                                                            View all{" "}
                                                            <img
                                                                src={
                                                            ...
                                                            .map(
                                                                (data, index) =>
                                                                    data[0] ? (
                                                                        <div className="col-md-4">
                                                                            <NavLink
                                                                                to={`/team-details/${data[0]?.team_id}`}
                                                                                onClick={() =>
                                                                                    scrollTo(
                                                                                        0,
                                                                                        0
                                                                            ...
                                                                            >
                                                                                <img
                                                                                    src={`${baseurl}/storage/${data[0]?.path}`}
                                                                                    className="img-fluid"
                                                                                    alt="doctor"
                                                                                />
                                                                                <h5>
                                            ...
                                            <div className="medical-block">
                                                ...
                                                <div className="row mb-5">
                                                    {Array.isArray(
                                                        ...
                                                        masterclass
                                                            .filter(data =>
                                                                data.masterclass_title.includes(
                                                                    searchKey
                                                                )
                                                            )
                                                            .map(
                                        ...
                                        <div
                                            ...
                                            id="dr-masterclass"
                                            role="tabpanel"
                                            aria-labelledby="dr-masterclass-tab"
                                        >
                                            <div class="medical-block">
                                                <div class="row mb-2">
                                                    <div class="col-md-9">
                                        ...
                                        <div
                                            ...
                                            id="dr-document"
                                            role="tabpanel"
                                            aria-labelledby="dr-document-tab"
                                        >
                                            <div class="medical-block">
                                                <div class="row mb-2">
                                                    <div class="col-md-9">
            ...
            {Array.isArray(follows.publications) &&
                follows.publications.map((data, index) => (
                    <div
                        className="modal fade"
                        id={"publicationModal-" + data.id}
                        tabIndex="-1"
                        role="dialog"
            ...
            {Array.isArray(follows.images) &&
                follows.images.map((data, index) => (
                    <div
                        className="modal fade"
