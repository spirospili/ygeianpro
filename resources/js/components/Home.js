...
class Home extends Component {
    ...
    updateVideos() {
        axios("/api/videos?page=home").then(
            (response) => {
                console.log("responsepi", response);
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-8 text-center">
                                <h1>
                                    See The best Doctors in Action. Learn new
                                    techniques through Live streaming from the
                                    best Hospitals
                                </h1>
                                <p>
                                    We are YGEIAN Pro. A multimedia library with
                                    Live Streamed and Recorded videos from OR,
                                    Medical Journals from Top Doctors around the
                                    world. Join seminars and courses and learn
                                    new techniques from the best.
                                </p>
                                {this.state.isLoggedIn &&
                                this.state.user.payment_info ? null : (
                                    <NavLink
                                        to={
                                            this.state.isLoggedIn &&
                                            this.state.user.payment_info == null
                                ...
                                <img
                                    src={scrollImg}
                                    className="img-fluid scrolling-img"
                                    alt="slider"
                                />
                            </div>
                        </div>
                            ...
                            <div className="col-md-9">
                                <div className="row">
                                    <div className="col-md-6">
                                        <img
                                            src={doctorImageAbout}
                                            class="img-responsive"
                                        />
                                    </div>
                                    <div className="col-md-6 doctor-sig-center">
                                        <p>
                                            When you share your passion then
                                            medicine becomes art.
                                        </p>
                                                ...
                                                <div className="theme-block-style">
                                                    {(() => {
                                                        if (
                                                            ...
                                                            return (
                                                                // This is the old code for displaying Just videos on Home Page.
                                                                ...
                                                                // This is the new code to disply Videos with thumbnails on Home Page.
                                                                ...
                                                                >
                                                                    <video
                                                                        ...
                                                                        poster={
                                                                            video.v_thumbnail !=
                                                                            null
                                                                                ? `${baseurl}/storage/${video.v_thumbnail}`
                                                                                : ""
                                                                        }
                                                                    >
                                                                        <source
                                                            ...
                                                            return (
                                                                // This is the old code for displaying videos of Home Page
                                                                ...
                                                                // This is the new code for displaying thumbnails of videos on Home Page
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src={nextWhiteIcon}
                                                    className="img-fluid hvr-icon blue"
                                                    alt="arrow"
                                                />
                                            </NavLink>
                                        </div>
                                ...
                                {this.state.teams && (
                                    <div className="trending-slider row">
                                        {this.state.teams.map((doctor) => (
                                            <div className="col-md-6">
                                                <NavLink
                                                    to={`/team-details/${doctor.team_id}`}
                                                    onClick={() =>
                                                        scrollTo(0, 0)
                                                    }
                                                >
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        >
                                                            ...
                                                            <video
                                                                ...
                                                                className="videoHeight"
                                                                control
                                                                poster={`${baseurl}/storage/${doctor.m_thumbnail}`}
                                                            >
                                                                <source
                                                                    src={
                                                                        "https://img.youtube.com/vi/" +
                    ...
                    <div>
                        {this.state.publications.map((publication, index) => (
                            <div
                                ...
                                id={"publicationModal-" + publication.id}
                                tabindex="-1"
                                role="dialog"
